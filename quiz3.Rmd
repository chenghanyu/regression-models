---
title: "Coursera Regression Models Quiz 3"
author: "Cheng-Han Yu"
date: "August 11, 2015"
...
Note that `r abs(round(summary(fit1)$coef[3], 3))` > `r abs(round(summary(fit)$coef[3], 3))`, and so holding weight constant, cylinder appears to have less of an impact on mpg than if weight is disregarded.
